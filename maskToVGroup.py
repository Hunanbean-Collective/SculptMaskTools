...
class MaskToVertexGroup(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
#CLEAR
class ClearAllMasks(bpy.types.Operator):
    bl_idname = "paint.clear_all_masks"
    bl_label = "Clear All Masks"
    bl_description = "Clear all masks"
    bl_options = {'REGISTER'}
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, "Cleared all masks")
        return {'FINISHED'}
